    ...
    WAGz: function (n, t, e) {
      ...
      function l(n, t) {
        if (1 & n) {
          ...
          g.Tb(0, 'div'),
            ...
            g.Tb(3, 'button', 7),
            g.ac('click', function () {
              return g.tc(e), (g.ec().dom.fullscreen = !0);
            }),
            g.Ac(4, 'PDF '),
            g.Ob(5, 'i', 8),
            g.Sb(),
            g.Tb(6, 'button', 9),
            g.ac('click', function () {
              return g.tc(e), (g.ec().dom.views.selected = 'invoice');
            }),
            g.Ob(7, 'i', 10),
            g.Sb(),
            g.Ac(8, ' | '),
            g.Tb(9, 'button', 9),
            g.ac('click', function () {
              return g.tc(e), (g.ec().dom.views.selected = 'timesheet');
            }),
            g.Ob(10, 'i', 11),
            g.Sb(),
            g.Sb(),
      ...
      function p(n, t) {
        if (
          ...
          var e,
            ...
            i = g.ec(2);
          g.Ab(3),
            g.Bc(c.value.project),
            g.Ab(2),
            g.Cc(' ', c.value.title, ' '),
            g.Ab(4),
            g.Cc('\u20ac ', null == (e = g.gc(10, 5, i.dom.invoice)) ? null : e.rate, ''),
            g.Ab(3),
            g.Cc('', c.value.days, ' '),
            g.Ab(2),
            g.Cc(
              '',
              g.hc(15, 7, c.value.days * (null == (o = g.gc(16, 10, i.dom.invoice)) ? null : o.rate), '\u20ac'),
              ' '
            );
        }
      }
      function s(n, t) {
        if (
          ...
          var e,
            o = g.ec(),
            c = null,
            i = g.gc(81, 15, null == (e = g.gc(82, 17, o.dom.invoice)) ? null : e.charges),
            r = null,
            a = null,
            d = null;
          g.Ab(51),
            g.Cc(' ', g.gc(52, 6, o.dom.invoice).title, ' '),
            g.Ab(11),
            g.Cc(
              ' ',
              g.hc(
                63,
                8,
                o.getTotalDays(null == (c = g.gc(64, 11, o.dom.invoice)) ? null : c.charges) *
                  (null == (c = g.gc(65, 13, o.dom.invoice)) ? null : c.rate) *
                  1.0,
                '\u20ac'
              ),
              ' '
            ...
            g.Cc(
              ...
              g.hc(
                90,
                19,
                o.getTotalDays(null == (r = g.gc(91, 22, o.dom.invoice)) ? null : r.charges) *
                  (null == (r = g.gc(92, 24, o.dom.invoice)) ? null : r.rate),
                '\u20ac'
              ),
              ' '
            ),
            ...
            g.Cc(
              ...
              g.hc(
                98,
                26,
                o.getTotalDays(null == (a = g.gc(99, 29, o.dom.invoice)) ? null : a.charges) *
                  (null == (a = g.gc(100, 31, o.dom.invoice)) ? null : a.rate) *
                  0.0,
                '\u20ac'
              ),
              ' '
            ...
            g.Cc(
              ...
              g.hc(
                106,
                33,
                o.getTotalDays(null == (d = g.gc(107, 36, o.dom.invoice)) ? null : d.charges) *
                  (null == (d = g.gc(108, 38, o.dom.invoice)) ? null : d.rate) *
                  1.0,
                '\u20ac'
              ),
              ' '
      ...
      function _(n, t) {
        if (
          ...
          var e = t.$implicit,
            o = g.ec(2);
          g.Ab(2), g.Bc(g.gc(3, 2, o.dom.timesheet)[e]), g.Ab(5), g.Bc(g.hc(8, 4, e, 'dd'));
        }
      }
      function f(n, t) {
        if (
      ...
      function P(n, t) {
        if (
          (1 & n &&
            ...
            g.fc(28, 'async'),
            g.zc(29, f, 9, 7, 'div', 57),
            g.fc(30, 'async'),
            g.zc(31, O, 9, 7, 'div', 57),
            g.fc(32, 'async'),
            g.zc(33, C, 9, 7, 'div', 57),
            g.fc(34, 'async'),
          ...
          var e,
            ...
            c = g.ec();
          g.Ab(3),
            g.Cc(' ', g.hc(4, 7, null == (e = g.gc(5, 10, c.dom.range)) ? null : e.from, 'MMMM'), ' '),
            g.Ab(6),
            g.Bc(g.hc(10, 12, null == (o = g.gc(11, 15, c.dom.range)) ? null : o.from, 'yyyy')),
            g.Ab(18),
            g.lc('ngForOf', g.gc(28, 17, c.dom.calendar)[0].days),
            g.Ab(2),
            g.lc('ngForOf', g.gc(30, 19, c.dom.calendar)[1].days),
            g.Ab(2),
            g.lc('ngForOf', g.gc(32, 21, c.dom.calendar)[2].days),
            g.Ab(2),
            g.lc('ngForOf', g.gc(34, 23, c.dom.calendar)[3].days),
            g.Ab(2),
            g.lc('ngForOf', g.gc(36, 25, c.dom.calendar)[4].days);
        }
      }
      var v,
        u,
        ...
        m =
            ...
            function n(t) {
              _classCallCheck(this, n),
                ...
                (this.dom = {
                  ...
                  range: this.store.select('ui').pipe(
                    Object(r.a)(function (n) {
                      return { from: n.invoice.draft.dateFrom, to: n.invoice.draft.dateTo };
                    })
                  ),
                  invoice: this.store.select('ui').pipe(
                    Object(r.a)(function (n) {
                      return n.invoice.draft;
                    })
                  ),
                    ...
                    Object(r.a)(function (n) {
                      for (
                        var t = [],
                          ...
                          c = d.a.utc(o + '-' + (e + 1) + '-01Z').startOf('week'),
                          i = 0;
                        i < 5;
                        i++
                      )
                  ...
                  timesheet: this.store.select('ui').pipe(
                    Object(r.a)(function (n) {
                      var t = {};
                      return (
                        n.invoice.draft.logs.forEach(function (n) {
                          var e = n.date;
          ...
          (u.ɵcmp = g.Hb({
            ...
            consts: [
              ...
              [1, 'row'],
              [1, 'col-md-12'],
              [2, 'display', 'block', 'height', '1px', 'width', '100%', 'background', '#f0f0f0', 'margin', '30px 0px'],
              [1, 'invoice-card'],
              [1, 'header'],
              [1, 'ids'],
              [
            ...
            template: function (n, t) {
              1 & n &&
                ...
                g.Tb(1, 'div', 1),
                g.zc(2, l, 20, 0, 'div', 2),
                g.zc(3, s, 137, 40, 'div', 3),
                g.zc(4, P, 37, 27, 'div', 4),
                g.Sb(),
                g.Sb()),
                2 & n &&
                  (g.lc('ngClass', g.nc(4, h, t.dom.fullscreen)),
                  g.Ab(2),
        ...
        x =
          ...
          (v.ɵinj = g.Kb({
            ...
            imports: [[o.c, i.a, c.h.forChild([{ path: '', component: m }])]],
          })),
          v);
    },
  },
